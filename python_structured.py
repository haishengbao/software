...
def repair_program_io(code):
    ...
    pattern_case1_in = re.compile(r"In ?\[\d+\]: ?")  # flag1
    pattern_case1_out = re.compile(r"Out ?\[\d+\]: ?")  # flag2
    pattern_case1_cont = re.compile(r"( )+\.+: ?")  # flag3

    # reg patterns for case 2
    pattern_case2_in = re.compile(r">>> ?")  # flag4
    pattern_case2_cont = re.compile(r"\.\.\. ?")  # flag5
